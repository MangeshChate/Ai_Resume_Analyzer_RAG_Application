      ...
      <div className="max-w-6xl mx-auto space-y-8 ">
        <div className="bg-white p-6 rounded-xl shadow-lg">
          <h2 className="text-2xl font-semibold mb-4 text-indigo-700 flex items-center">
            <FiFileText className="h-8 w-8 mr-2 text-indigo-600" />
            Upload Resume
          </h2>
          ...
          <button
            ...
            className={`w-full mt-4 py-3 px-6 text-white rounded-md ${
              pdfText.trim() === "" || isLoading
                ? "bg-gray-400 cursor-not-allowed"
                : "bg-indigo-600 hover:bg-indigo-700"
            } transition duration-200 ease-in-out font-semibold flex items-center justify-center`}
        ...
        <div className=" mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
          <div className="bg-white p-6 rounded-xl shadow-lg">
            <h3 className="text-2xl font-semibold mb-4 text-indigo-700 flex items-center">
              <FiAlertTriangle className="h-7 w-7 mr-2 text-yellow-500" />
              Improvement Suggestions
            </h3>
            <ul className="space-y-2 text-gray-700">{formatList(suggestions)}</ul>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-lg">
            <h3 className="text-2xl font-semibold mb-4 text-indigo-700 flex items-center">
              <FiCheckCircle className="h-7 w-7 mr-2 text-green-500" />
              Strengths
            </h3>
            <ul className="space-y-2 text-gray-700">{formatList(goodPoints)}</ul>
          </div>
        </div>
      )}
    </div>
